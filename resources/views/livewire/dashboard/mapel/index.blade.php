...
<div>
    <div class="p-4 sm:ml-64">
        ...
        @endif
        <p class="mb-5"><a href="{{ route('mapel.create') }}"
                class="w-full text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
                wire:navigate>Baru</a></p>

        <form class="max-w-md mb-5" wire:submit="find" enctype="multipart/form-data">
            ...
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                    <tr>
                        ...
                        <th scope="col" class="px-6 py-3">
                            <a wire:click.prevent="sortBy('nama_mapel')" role="button" href="#">Mapel <svg
                                    class="w-3 h-3 inline-block text-gray-800 dark:text-white" aria-hidden="true"
                                    xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 12 20">
                                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-width="2"
                    ...
                    @foreach ($data as $k)
                        <tr
                            ...
                            <td class="px-6 py-4 text-right">
                                <a href="{{ route('mapel.edit', $k->id) }}" wire:navigate
