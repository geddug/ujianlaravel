...
<div>
    <div class="p-4 sm:ml-64">
        ...
        @endif
        <p class="mb-5"><a href="{{ route('soal.create') }}"
        ...
        <form class="md:grid grid-cols-4 gap-4 mb-5" wire:submit="find">
            <select
                ...
                wire:model="selectedMapel" wire:change="find">
            ...
            <select
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 mb-5"
                wire:model="selectedMateri" wire:change="find">
                ...
                <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                    <tr>
                        <th scope="col" class="px-6 py-3">
                            <a wire:click.prevent="sortBy('id')" role="button" href="#">No <svg
                        ...
                        <th scope="col" class="px-6 py-3">
                            <a wire:click.prevent="sortBy('materi.nama_materi')" role="button" href="#">Materi
                                <svg class="w-3 h-3 inline-block text-gray-800 dark:text-white" aria-hidden="true"
                                    xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 12 20">
                                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-width="2"
                                        d="M10.335 6.514 6.91 1.464a1.122 1.122 0 0 0-1.818 0l-3.426 5.05a.988.988 0 0 0 .91 1.511h6.851a.988.988 0 0 0 .91-1.511Zm-8.67 6.972 3.426 5.05a1.121 1.121 0 0 0 1.818 0l3.426-5.05a.988.988 0 0 0-.909-1.511H2.574a.987.987 0 0 0-.909 1.511Z">
                        ...
                        <th scope="col" class="px-6 py-3">
                            <a wire:click.prevent="sortBy('pertanyaan')" role="button" href="#">Soal <svg
                                    class="w-3 h-3 inline-block text-gray-800 dark:text-white" aria-hidden="true"
                                    xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 12 20">
                                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-width="2"
                    ...
                    @foreach ($data as $k)
                        <tr
                            ...
                            <td class="px-6 py-4 text-right">
                                <a href="{{ route('soal.edit', $k->id) }}" wire:navigate
