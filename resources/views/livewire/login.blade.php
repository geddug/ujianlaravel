...
<div>
    <section class="bg-gray-50 dark:bg-gray-900">
        <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 bg-white rounded-lg shadow dark:border md:mt-0 xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                <div>
                ...
                <div><img src="/upload/static/login.webp" style="width:500px; max-width:100%;"></div>
            </div>
